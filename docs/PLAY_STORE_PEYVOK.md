...
- Günlük kelime oyunu
- AI'ya karşı kelime tahtası
- Arkadaşlarla ve rastgele oyuncularla multiplayer
- Kurmancî Ferheng sözlük
- Kelime anlamları
- Sıralama, istatistikler ve başarımlar
...
Etiket önerileri:
`kelime oyunu, Kurmancî, Kürtçe, Wordle, sözlük, Ferheng, multiplayer, zeka oyunu`
...
Toplanan veriler:
- Kullanıcı kimliği
- E-posta adresi veya Google hesap kimliği
...
`Evet, yalnızca uygulamanın çalışması için Firebase/Google servisleriyle. Reklam veya satış amaçlı paylaşım yok.`

Veriler şifreleniyor mu?
`Evet, aktarım sırasında şifreleniyor.`

Kullanıcı veri silme talep edebilir mi?
`Evet`

Reklam kimliği kullanılıyor mu?
`Hayır`

Konum, kamera, mikrofon, kişiler toplanıyor mu?
`Hayır`
...
Play Console'a yüklenecek önerilen ekran görüntüleri:
1. Ana sayfa
2. Günün Kelimesi ekranı
3. Kelime tahtası
4. Multiplayer veya arkadaşla oynama ekranı
5. Sıralama
6. Ferheng sözlük
7. Profil veya başarımlar

## Yayın Öncesi Kontrol

- Dahili test sürümü yayında mı?
...
- İçerik derecelendirmesi tamamlandı mı?
