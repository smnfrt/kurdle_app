                    ...
                    Align(
                      ...
                      child: GestureDetector(
                        ...
                        child: Text('Şifremi Unuttum',
                            style: TextStyle(
                                color: _kPrimary.withOpacity(0.8), fontSize: 12)),
                      ),
                    ),
                  ],
      ...
      builder: (ctx) => AlertDialog(
        ...
        actions: [
          TextButton(
            ...
            child: Text('İptal', style: TextStyle(color: Colors.white.withOpacity(0.4))),
          ),
          ElevatedButton(
            onPressed: () async {
              ...
              ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                ...
                backgroundColor: err != null ? Colors.red.shade800 : Colors.green.shade800,
