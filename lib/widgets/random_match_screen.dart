...
class _RandomMatchScreenState extends State<RandomMatchScreen>
  ...
  Future<void> _startSearch() async {
    ...
    try {
      final code = await MultiplayerService.instance
          .findOrCreateRandomRoom(uid, name);
      if (!mounted) return;

      // Direkt aktif olduysa (var olan odaya katıldık)
      final snap = await MultiplayerService.instance
          .roomStream(code)
          .first;
  ...
  void _onMatched(String code, MultiplayerRoom room, String myUid) {
    ...
    setState(() { _found = true; _opponentName = opp; });
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Icon(Icons.close_rounded,
                            color: _found ? Colors.white24 : Colors.white54, size: 20),
                      ),
                    ),
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      BoxShadow(color: _kBlue.withOpacity(0.25), blurRadius: 18, spreadRadius: 2),
                    ],
                  ),
                  child: const Icon(Icons.person_search_rounded, color: _kBlue, size: 34),
                ),
              ],
            ),
          ),
          ...
          TweenAnimationBuilder<double>(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                shape: BoxShape.circle,
                boxShadow: [
                  BoxShadow(color: _kPrimary.withOpacity(0.4), blurRadius: 22, spreadRadius: 3),
                ],
              ),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 28),
            _CancelBtn(onTap: () { if (mounted) Navigator.pop(context); }),
          ],
        ),
      ),
    );
...
class _SonarRing extends StatelessWidget {
  ...
  const _SonarRing({required this.ctrl, required this.delay, required this.color});
