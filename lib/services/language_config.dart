class LanguageConfig {
  ...
  /// Oyun dili arayüz dilinden bağımsızdır.
  ///
  /// `L.current` yalnızca menü/metin dilini değiştirmeli; wordlist, harf
  /// torbası ve puanlama sabit Kurmancî oyun kurallarıyla çalışır.
  static LanguageConfig get current => kurdish;
