...
class L {
  ...
  static String get moveScore => _s('Hamle puanı', 'Xala vê gavê');
  static String get placeTilesForScore =>
      _s('Taş koydukça görünür', 'Herfan danîne, xal xuya dibe');
  ...
  static String get howToPlay =>
      _s('Nasıl oynamak istersin?', 'Tu çawa dixwazî bilîzî?');
  static String get aiPlay => _s('AI ile Oyna', 'Bi AI re bilîze');
  static String get friendPlay =>
      _s('Arkadaşlarınla Oyna', 'Bi hevalên xwe re');
  static String get friendPlaySub =>
      _s('Arkadaşını davet et', 'Hevalê xwe vexwîne');
  static String get findPlayer => _s('Oyuncu Bul', 'Lîstikvan Bibîne');
  static String get findPlayerSub =>
      _s('Rastgele eşleş', 'Bi rengekî tesadufî');
  ...
  static String get searchByUsername =>
  ...
  static String get inviteFrom =>
      _s('seni oyuna davet etti', 'te vexwand bo lîstikê');
  ...
  static String get noUsersFound =>
      _s('Kullanıcı bulunamadı', 'Bikarhêner nehatin dîtin');
  ...
  static String get searchingPlayer =>
      _s('Oyuncu aranıyor', 'Lîstikvan tê gerîn');
  static String get searchingDesc => _s('Seni bekleyen bir rakip aranıyor...',
      'Li dijberek ku li bendê ye tê gerîn...');
  static String get matchFound => _s('Rakip bulundu!', 'Dijber hat dîtin!');
  static String get matchFoundDesc =>
      _s('Oyun başlıyor...', 'Lîstik dest pê dike...');
  static String get searchError => _s('Bağlantı hatası', 'Xeleta pêwendiyê');
  static String get needSignIn =>
      _s('Oynamak için giriş yapman gerekiyor', 'Ji bo lîstinê divê têkevî');
  static String get createRoom => _s('Oda Oluştur', 'Ode çêke');
  static String get joinRoom => _s('Odaya Katıl', 'Bikevin odeyê');
  static String get createRoomDesc => _s(
      'Oda oluşturun, kodu arkadaşınızla paylaşın.',
  ...
  static String get comingSoon =>
      _s('Bu özellik yakında geliyor!', 'Ev taybetmendî bê dî tê!');
  ...
  static String get exchangeSub => _s(
      'değiştirmek istediklerini seç', 'yên ku dixwazî biguherînî hilbijêre');
  static String get resign => _s('Teslim Ol', 'Teslîm bibe');
  static String get resignSub => _s('Oyunu bitir, rakibin kazanır',
      'Lîstikê biqedîne, heyfa te bi ser dikeve');
  ...
  static String get placeTile =>
      _s('Tahtaya harf yerleştir!', 'Tîpê li ser texteyê bide!');
  static String get sameRowCol => _s('Harfler aynı satır veya sütunda olmalı!',
      'Tîp divê di heman rêz an stûnê de bin!');
  static String get centerFirst => _s('İlk hamle merkez kareden (★) geçmeli!',
      'Yekem livê divê ji navenda (★) derbas bibe!');
  static String get touchLocked => _s(
      'Harfler mevcut kelimelerle bitişik olmalı!',
      'Tîp divê bi peyvên heyî re bitişik bin!');
  static String get noWord =>
      _s('Geçerli bir kelime oluşmadı!', 'Peyva derbasdar nehat!');
  ...
  static String get noPassLeft =>
      _s('Pas hakkın kalmadı!', 'Mafê te yê derbasbûnê nemaye!');
  static String get notEnoughTiles =>
      _s('Torbada yeterli harf yok!', 'Di torê de tîpên têr nîn!');
  static String get selectTile =>
      _s('En az bir harf seç!', 'Herî kêm yek tîp hilbijêre!');
  static String get exchangeConfirm => _s('Değiştir', 'Biguherîne');
  static String get exchangeTitle => _s(
      'Hangi harfleri değiştirmek istiyorsun?',
      'Tu dixwazî kîjan tîpan biguherînî?');
  static String get meaningNotFound =>
      _s('Anlam bulunamadı', 'Wate nehat dîtin');
  static String get meaningLoading =>
      _s('Anlamlar yükleniyor...', 'Wate tên barkirin...');
  static String get dictionaryWordNotFound =>
      _s('Bu kelime sözlükte bulunamadı', 'Ev peyv di ferhengê de nehat dîtin');
  static String get missingTurkishMeaning =>
      _s('Türkçe anlam henüz eklenmedi', 'Wateya Tirkî hîn nehatiye zêdekirin');
  static String get missingKurdishMeaning =>
      _s('Kürtçe anlam henüz eklenmedi', 'Wateya Kurdî hîn nehatiye zêdekirin');
  static String get dictionaryEntryMissingMeaning => _s(
      'Bu kelime sözlükte var ancak anlamı henüz eklenmedi',
      'Ev peyv di ferhengê de heye lê wateya wê hîn nehatiye zêdekirin');
  static String get playableWordMissingMeaning => _s(
      'Bu kelime oyunda geçerli ancak anlamı henüz sözlüğe eklenmedi',
      'Ev peyv di lîstikê de derbasdar e lê wateya wê hîn li ferhengê nehatiye zêdekirin');
  static String get gameEndedByPasses => _s(
      'Toplam pas limiti doldu — oyun bitti!',
      'Sînorê derbasbûnê temam bû — lîstik qediya!');
  static String get timeoutLose =>
      _s('Süre doldu — yenildin!', 'Dem qediya — tu şikestî!');
  ...
  static String get stealBonus => _s('+5 çalma bonusu', '+5 bonus dizînê');
  static String stealInfo(String base, String next, int added) =>
      _s('"$base" → "$next" (+$added harf)', '"$base" → "$next" (+$added tîp)');
  static String get noStealLeft =>
      _s('Çalma hakkın kalmadı!', 'Mafê te yê dizînê nemaye!');
  static String get stealModeActive => _s('Çalma modu aktif — kelimeyi uzat!',
  ...
  static String get howToRule1 => _s(
      'Her tahmin geçerli bir beş harfli kelime olmalıdır. Göndermek için ENTER\'a basın.',
      'Her texmîn divê peyva pênc-tîpî ya derbasdar be. Ji bo şandinê bişkoka ENTER bixin.');
  static String get howToRule2 => _s(
      'Her tahminden sonra karoların rengi, tahminin kelimeye ne kadar yakın olduğunu göstermek için değişir.',
      'Piştî her texmînê, rengê kelikên dê biguheze da ku nîşan bide texmîna te çiqas nêzîkî peyvê bû.');
  static String get howToExamples => _s('Örnekler', 'Mînak');
  static String get howToCorrect => _s(
      'harfi kelimede ve doğru yerde.', 'di peyvê de ye û di cîhê rast de ye.');
  static String get howToPresent => _s('harfi kelimede ama yanlış yerde.',
      'di peyvê de ye lê di cîhê şaş de ye.');
  static String get howToAbsent =>
      _s('harfi kelimede yok.', 'di peyvê de tune ye.');
  ...
  static String get signInRegister =>
      _s('Giriş Yap / Kayıt Ol', 'Têkeve / Qeydê bike');
  ...
  static String guestName(String suffix) =>
      _s('Misafir $suffix', 'Mêvan $suffix');
  static String get linkWithGoogle =>
      _s('Google ile Bağla', 'Bi Google ve Girêde');
  static String get signInToSaveScores =>
      _s('Giriş yaparak skorlarını kaydet', 'Têkeve da ku xalên xwe biparêzî');
  ...
  static String get step1Body => _s(
      "Raftaki harfleri tahtaya surukle veya secip bos kareye dokun.",
      'Tîpên ji reyê li ser textê bikişîne an hilbijêre û li qada vala pêk bixin.');
  static String get step2Title => _s('Geçerli Kelime', 'Peyveke Derbasdar');
  static String get step2Body => _s(
      'Kürmanci kelimeler oluştur. Tüm harfler mevcut kelimelerle bitişik olmalı.',
      'Peyvên Kürmancî çêke. Divê hemû tîp bi peyvên heyî re bitişik bin.');
  static String get step3Title => _s('AI Sırasını Bekle', 'Rêza AI Bisekine');
  static String get step3Body => _s(
      'Sen oynarken AI da hamlesini yapar. Tahtayı stratejik kullan!',
      'Dema tu dilîzî, AI jî livê xwe dike. Texteyê stratejîk bikar bîne!');
  static String get step4Title => _s('Bonus Kareler', 'Qadên Bonus');
  static String get step4Body => _s(
      '2W / 3W kelime puanını, 2L / 3L harf puanını katlar. ★ merkez kare ilk hamle için zorunlu.',
      '2W / 3W nirxa peyvê, 2L / 3L nirxa tîpê du-sê qat dike. ★ ji bo yekem livê hewce ye.');
  static String get step5Title => _s('Oyunu Kazan', 'Lîstikê Bibe');
  static String get step5Body => _s(
      'Tüm harfler bittiğinde ya da toplam 5 pas geçilince en yüksek skora sahip oyuncu kazanır.',
      'Dema hemû tîp qedin an bi tevayî 5 caran derbas bibe, yê ku xalên herî zêde hebe bi ser dikeve.');

  // ── Günün Kelimesi (Wordle) ────────────────────────────────────
  static String get wordleSectionTitle => _s('Günün Kelimesi', 'Peyvê Roja');
  static String get wordleIntro => _s(
      '6 denemede 5 harfli Kürmancî kelimeyi bul.',
      'Di 6 hewlan de peyveke 5 tîpî ya Kürmancî bibîne.');
  static String get wordleCorrectTitle =>
      _s('Doğru Harf, Doğru Yer', 'Tîpa Rast, Cîhê Rast');
  static String get wordleCorrectBody => _s(
      'Harf kelimede ve tam doğru konumda.',
      'Tîp di peyvê de ye û di cîhê rast de ye.');
  static String get wordlePresentTitle =>
      _s('Kelimede Var, Yanlış Yer', 'Di Peyvê de ye, Cîhê Şaş');
  static String get wordlePresentBody => _s(
      'Harf kelimede var ama farklı bir konumda.',
      'Tîp di peyvê de ye lê di cîhê şaş de ye.');
  static String get wordleAbsentTitle => _s('Kelimede Yok', 'Di Peyvê de Tune');
  static String get wordleAbsentBody =>
      _s('Bu harf kelimede hiç yok.', 'Ev tîp di peyvê de tune ye.');
  static String get wordleTip => _s('Her gün saat 09:00\'da yeni kelime!',
      'Her roj saet 09:00 de peyveke nû!');
  static String get scrabbleSectionTitle =>
      _s('Scrabble Modu', 'Moda Scrabble');

  // ── Wordle doğrulama hataları ──────────────────────────────────
  static String get notEnoughLetters =>
      _s('Yeterli harf yok!', 'Tîpên têr nîn!');
  static String get notInWordList =>
      _s('Kelime listesinde yok!', 'Di lîsteya peyvan de tune!');
  static String mustContainLetter(String letter) => _s(
      'Tahmin "$letter" harfini içermeli!', 'Texmîn divê tîpa "$letter" hebe!');
  ...
  // ── Günlük Meydan Okuma ────────────────────────────────────────
  static String get dailyChallenge =>
      _s('Günlük Meydan Okuma', 'Pêşangiriya Rojane');
  ...
  static String get wrongAnswer =>
      _s('Yanlış! Tekrar dene', 'Şaş e! Dîsa biceribîne');
  static String get correctAnswer => _s('Doğru! ✓', 'Rast e! ✓');
  static String get perfectBonus => _s('Mükemmel Bonus!', 'Bonus Bêkêmasî!');
  static String get challengeDone =>
      _s('Bugünkü meydan okuma tamamlandı!', 'Pêşangiriya îro qediya!');
  ...
  static String stagesResult(int n) =>
      _s('$n/3 kelime tamamlandı', '$n/3 peyv hatin temamkirin');
  static String earnedPoints(int n) =>
      _s('+$n puan kazandın!', '+$n xal bi dest xistin!');
  static String get meaningHint => _s('Türkçe anlamı:', 'Wateya Tirkî:');
  static String get quickPlay => _s('Hemen Oyna', 'Zû Bilîze');
  static String get quickPlaySub =>
      _s('AI ile hızlı başlat', 'Bi AI re zû dest pê bike');
  static String get dailyGoal =>
      _s('Bugün: 3 kelimeyi tamamla', 'Îro: 3 peyvan temam bike');
  ...
  static String get aiEasy => _s('Rahat Oyna', 'Gera Germkirinê');
  static String get aiNormal => _s('Denk Rakip', 'Ser bi ser');
  static String get aiHard => _s('Meydan Oku', 'Hostayê Peyvan');
  static String get aiEasyDesc =>
      _s('Kısa kelimeler, rastgele hamleler', 'Peyvên kurt, livên tesadufî');
  static String get aiNormalDesc =>
      _s('Optimal skor, tahta birleşimleri', 'Xala herî baş, hevbendiya textê');
  static String get aiHardDesc => _s('Derin arama, çoklu anchor, agresif',
      'Lêgerîna kûr, gelek anchor, agresîf');
  ...
  static String get ferhengNoDefinition =>
      _s('Anlam bulunamadı', 'Wate nehat dîtin');
  static String get ferhengContribute =>
      _s('Anlam öner', 'Wateyê pêşniyar bike');
  static String get ferhengAddedFav =>
      _s('Favorilere eklendi', 'Li bijartiyan hat zêdekirin');
  static String get ferhengRemovedFav =>
      _s('Favorilerden çıkarıldı', 'Ji bijartiyan hat rakirin');
  ...
  static String get ferhengAttribution => _s(
      'Veri: KurdishHunspell + Wîkîferheng (CC BY-SA 4.0)',
      'Daneyên: KurdishHunspell + Wîkîferheng (CC BY-SA 4.0)');
  static String get ferhengOfflineBanner => _s(
      'Çevrimdışısın — önbellek gösteriliyor.',
      'Tu offlîne yî — daneya kevn tê nîşandan.');
